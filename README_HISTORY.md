...
- Added a `HomeScreen` with a bottom navigation bar and set it as app home. (`lib/screens/home_screen.dart`, `lib/main.dart`)
  - Removed the placeholder "Actions" tab and the floating action button per request.
